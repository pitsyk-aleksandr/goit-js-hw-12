...
export function showLoadMoreButton() {
  ...
  const btnLoadMoreEl = document.querySelector('.btn-loadmore');
  // Додаємо класс видимості кнопки
  btnLoadMoreEl.classList.add('visible');
}
// ==================================================================
...
export function hideLoadMoreButton() {
  // Посилання на кнопку "Load More"
  const btnLoadMoreEl = document.querySelector('.btn-loadmore');
  // Прибираємо класс видимості кнопки
  btnLoadMoreEl.classList.remove('visible');
}
// ==================================================================
